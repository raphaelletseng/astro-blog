...
export const siteConfig: SiteConfig = {
  title: "raphaëlle tsengzr",
  subtitle: "Raphaelle Tseng's bloggy blog",
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    // {
    //   name: "GitHub",
    //   url: "https://github.com/raphaelletseng", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: "hi friend!",
  bio: "I'm Raph, this is where I keep track of things.",
  links: [
    // {
    //   name: 'Twitter',
    ...
    },
    {
      ...
      url: "https://github.com/raphaelletseng",
    },
  ],
};
